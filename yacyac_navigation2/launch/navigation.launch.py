...
def generate_launch_description():
    package_name = "yacyac_navigation2"
    ...
    param_dir = LaunchConfiguration(
        "params_file", default=os.path.join(pkg_path, "param", param_file_name)
    )
    ...
    start_create_map_cmd = ExecuteProcess(
        cmd=["ros2", "run", "yacyac_commander", "create_map.py"], output="screen"
    )
