...
int main(int argc, char* argv[])
{
    ...
    try {
        camera_node = std::make_shared<CameraNode>(
            param_node.get_parameter("top_camera.topic_name").as_string(),
            param_node.get_parameter("top_camera.node_name").as_string(),
            param_node.get_parameter("top_camera.device").as_string(),
            param_node.get_parameter("top_camera.frame_width").as_int(),
    ...
    auto qr_detector_node = std::make_shared<QrDetectorNode>(
        param_node.get_parameter("qr.node_name").as_string(),
        param_node.get_parameter("qr.camera_topic_name").as_string(),
