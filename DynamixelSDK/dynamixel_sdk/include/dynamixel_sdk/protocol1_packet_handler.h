...
public:
    ...
    /// @description when txpacket is called by Protocol1PacketHandler::broadcastPing() / Protocol1PacketHandler::syncWriteTxOnly() / Protocol1PacketHandler::regWriteTxOnly /
    /// Protocol1PacketHandler::action
    /// @param port PortHandler instance
    /// @param txpacket packet for transmission
    /// @param rxpacket received packet
    /// @return COMM_SUCCESS
